...
// 与 novel-builder/scenes/scenes.test.tsx 同一约定：
...
import FSnapshot from './f-snapshot'
import FWhy from './f-why'
import FKnowledge from './f-knowledge'
import FReview from './f-review'
import FPlan from './f-plan'
import FFocus from './f-focus'
import PAgent from './p-agent'
import PScheduler from './p-scheduler'
import PLocalFirst from './p-local-first'
...
const MODULES: Record<string, () => ReactElement> = {
  'q-intro': QIntro,
  'f-snapshot': FSnapshot,
  'f-why': FWhy,
  'f-knowledge': FKnowledge,
  'f-review': FReview,
  'f-plan': FPlan,
  'f-focus': FFocus,
  'p-agent': PAgent,
  'p-scheduler': PScheduler,
  'p-local-first': PLocalFirst,
}
