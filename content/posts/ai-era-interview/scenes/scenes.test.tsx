...
import QRoute1 from './q-route-1'
import QRoute2 from './q-route-2'
import QSolution from './q-solution'
import QQuestion from './q-question'
import QObserve from './q-observe'
import QObjections from './q-objections'
...
const MODULES: Record<string, () => ReactElement> = {
  ...
  'q-route-1': QRoute1,
  'q-route-2': QRoute2,
  'q-solution': QSolution,
  'q-question': QQuestion,
  'q-observe': QObserve,
  'q-objections': QObjections,
}
...
describe('scenes/*.tsx 与 explore.yaml 对齐 + 渲染', () => {
  ...
  it.each(Object.keys(MODULES))('%s 渲染出非空内容（SceneClip 经 SceneDemoContext 拿到 yaml demo）', (id) => {
    setCurrentSlug('ai-era-interview')
