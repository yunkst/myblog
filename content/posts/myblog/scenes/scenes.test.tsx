// scenes.test.tsx — scenes/*.tsx ↔ explore.yaml 对齐 + 渲染冒烟（模板自带，新文章复制后改 slug 即可）
...
import QEngine from './q-engine'
import QDiagram from './q-diagram'
import QContent from './q-content'
import QVision from './q-vision'
