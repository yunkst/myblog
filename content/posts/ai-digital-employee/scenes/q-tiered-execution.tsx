...
/** 幕正文：q-tiered-execution（yaml label：第三层：分级执行（总览））—— 一幕一动画 */
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>如果接口是<strong>高风险</strong>的，必须由平台的<strong>管理员角色</strong>审批，只有管理员能真正在生产环境触发它；</li>
          </ul>
        </li>
        <li><strong>可逆接口的撤回</strong>：事后如果发现出了问题，在平台后台点一下"撤回"即可回滚操作。</li>
      </ul>
